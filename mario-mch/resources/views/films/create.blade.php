                    ...
                    <form method="POST" action="{{ route('films.store') }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('languageId') is-invalid @enderror"
                                    ...
                                    <option value="2" {{ old('languageId') == 2 ? 'selected' : '' }}>Français</option>
                                    <option value="3" {{ old('languageId') == 3 ? 'selected' : '' }}>Espagnol</option>
                                    <option value="4" {{ old('languageId') == 4 ? 'selected' : '' }}>Allemand</option>
                                    <option value="5" {{ old('languageId') == 5 ? 'selected' : '' }}>Italien</option>
                                    <option value="6" {{ old('languageId') == 6 ? 'selected' : '' }}>Japonais</option>
                                </select>
                                @error('languageId')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('rating') is-invalid @enderror"
                                    ...
                                    <option value="R" {{ old('rating') == 'R' ? 'selected' : '' }}>R - Interdit -17 ans sans adulte</option>
                                    <option value="NC-17" {{ old('rating') == 'NC-17' ? 'selected' : '' }}>NC-17 - Interdit -17 ans</option>
                                </select>
                                @error('rating')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save"></i> Créer le film
                            </button>
                        </div>
                    </form>
                </div>
